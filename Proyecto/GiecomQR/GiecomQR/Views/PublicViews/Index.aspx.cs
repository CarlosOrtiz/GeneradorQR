        ...
        protected void Btn_GenerarQr_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < DT.Rows.Count; i++)
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    ImgQr.ImageUrl = "data:image/git;base64," + Convert.ToBase64String(imageBytes);
                    ImgQr.Height = 200;
                    ImgQr.Width = 200;
                    ...
                    string body = String.Format(
                        ...
                        "<div style='text-align:center;padding:5%;'> <img src='data:image/git;base64," + Convert.ToBase64String(imageBytes) + "'/></div> " +
                    ...
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "swal('Exito!', 'En su correo institucional, le hemos enviado un link donde podra restablecer su contraseña', 'success');", true);
                }
            }
        }
    }
